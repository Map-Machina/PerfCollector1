...
const (
	...
	defaultLogFilename = "perfcollectord.log"
)
...
type config struct {
	...
	Listeners   []string `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 2222)"`
	Version     string
